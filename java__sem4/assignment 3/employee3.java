		...
		while(ans=='y')
		{
			...
			switch(ch)
			{
				...
				case 4: System.out.print("Enter ID of employee you want delete: ");
						...
						System.out.print("Employee NOT found in record!!!");		
						break;
				case 5: System.out.print("Enter IDs of the employees you want to compare: ");
						x=scm.nextInt();
						y=scm.nextInt();
						for(int i=0;i<c;i++)
						{
						...
						if(emp.sal>emp2.sal)
							...
							System.out.print("Employee-"+emp2.id+" and Employee-"+emp.id+" have the same salary.");
						break;
				case 6: for(int i=0;i<c-1;i++)
						{
							emp = new Employee();
							emp=e.get(i);
							for(int j=i+1;j<c;j++)
