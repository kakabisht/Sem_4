...
class Stack_array implements stk
{
...
class Stack_List  implements stk
{
    private Link first;
    public Stack_List()
    {
...
class Part3
{
    public static void main(String arg[])throws IOException
    {
        ...
        do
        {
            System.out.println("1.Push 2.Pop 3.Display 4.Exit 5.Growable Stack");
        ...
        while(ch<5);
        System.out.println("Implementation of Growable Stack ");
